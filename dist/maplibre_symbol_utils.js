var maplibre_symbol_utils = (function (exports, maplibreGl) {
    'use strict';
    ...
    */
    ...
    class Point3D extends maplibreGl.Point {
        constructor(x, y, z) {
            super(x, y);
            this.z = z;
            this.z = z || 0;
    ...
    class PyramidRoof {
        ...
        getVerticesFromRings(ring, height, base) {
            try {
                ...
                // Add the center point first
                let mercatorCenter = maplibreGl.MercatorCoordinate.fromLngLat({ 'lng': center[0], 'lat': center[1] }, height // Use scaled height
                );
                if (!this.debug_logged) {
                ...
                for (let point of ring) {
                    let mercatorPoint = maplibreGl.MercatorCoordinate.fromLngLat({ 'lng': point.x, 'lat': point.y }, base // Use scaled base
                    );
        ...
        getMLVerticesFromRings(ring, height, base) {
            ...
            */
            ...
            for (let p = 0; p < ring.length; p++) {
                ...
                let c1 = maplibreGl.MercatorCoordinate.fromLngLat({ 'lng': p1.x, 'lat': p1.y }, p1.z || base);
                p1 = new Point3D(c1.x, c1.y, c1.z);
                //}
                if (p >= 1) {
                    let p2 = ring[p - 1];
                    let c2 = maplibreGl.MercatorCoordinate.fromLngLat({ 'lng': p2.x, 'lat': p2.y }, p2.z || base);
